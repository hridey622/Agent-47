...
if TYPE_CHECKING:
	# from browser_use.agent.views import AgentOutput # Old import
	from agent_pychrome.agent_views import AgentOutput # Corrected import
